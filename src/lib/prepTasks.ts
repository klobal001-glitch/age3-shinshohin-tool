    ...
    milestones: [
      ...
      },
      {
        ...
        tasks: [
          ...
          {
            id: "price_base",
            label: "販売価格（標準／税込）（幸平さんOK）",
            note: "例外を入れていない店は、この価格で売る",
            linkedField: "priceBase",
          },
          {
            id: "price_base_uber",
            label: "└ 販売価格（Uber／税込）（幸平さんOK）",
            linkedField: "priceBaseUber",
          },
          {
            id: "price_kama",
            label: "販売価格（嘉麻／税込）（幸平さんOK）",
            linkedField: "priceStore:kama",
          },
          {
            id: "price_kama_uber",
            label: "└ 販売価格（Uber／税込）（幸平さんOK）",
            linkedField: "priceStoreUber:kama",
          },
          {
            id: "price_store_exceptions",
            label: "店舗別に価格が違う商品は、例外を全部入れたか",
            note: "全店同じなら、このまま完了にしてよい",
          },
          ...
          { id: "final_decision", label: "商品名・画像・価格（標準と店舗別）・期間 最終決定 → リーダーへ共有" },
