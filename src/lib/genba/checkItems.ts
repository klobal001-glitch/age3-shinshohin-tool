...
export const CHECK_ITEMS: CheckItem[] = [
  ...
  {
    title: "人の動き（その場に立って見る）",
    hint: "店の前に3分立つ。ここだけは行かないと分からない。数えるのは通行人なので、必ず取れる",
    points: [
      "1分間に店の前を通った人のうち、何人が店に気づいて振り向いた／速度を落としたか",
      "立ち止まった人は、何を見て立ち止まったか（看板・匂い・商品・行列）",
      "立ち止まったのに買わずに去った人は、何を見て去ったか",
      "買った人は、注文までにどこで迷ったか・何が決め手だったか",
      "揚げ物の匂いは何m手前から届くか／風向きで変わるか",
    ],
    memoTemplate: [
      "通行人◯人中 気づいた◯人：",
      "立ち止まった理由：",
