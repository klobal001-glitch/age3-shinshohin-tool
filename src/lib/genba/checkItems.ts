...
export const CHECK_ITEMS: CheckItem[] = [
  ...
  {
    title: "口コミ・SNSが生まれるか",
    hint: "案内が貼ってあるかではなく、実際に投稿・口コミまで届くかを見る",
    points: [
      "自分で1つ買ってみて、レビューやSNSの案内をされたか",
      "されたなら、どんな言い方・どのタイミングだったか",
      "QRを読み、外国のお客様が投稿まで行けるか（英語か・ログインが要るか・何回タップか）",
      "滞在中に写真を撮っている人がいたか／どこで撮っていたか",
      "Google口コミの直近で、繰り返し出ている指摘",
    ],
    memoTemplate: [
      "レビューの声掛け：",
      "QRの先（英語・手数）：",
