...
const seeds: Seed[] = [
  ...
  { id: "cinnamonapplepie", name: "青森県 シナモンアップルパイ", genre: "shop_limited" },
  ...
  { id: "umidarekarubi", name: "石川県 旨だれ牛カルビ焼肉", genre: "shop_limited" },
  { id: "chickennanban", name: "宮崎県 チキン南蛮", genre: "shop_limited" },
  { id: "cheesesalmon", name: "北海道 炙りチーズサーモン（スモークサーモン）", genre: "shop_limited" },
  { id: "houjicha", name: "ほうじ茶スリー（スイーツサンド）", genre: "sweets_sand" },
  ...
  { id: "takomeat", name: "タコミート", genre: "shop_limited" },
  { id: "shirasuavocado", name: "しらすサーモンアボカド", genre: "shop_limited" },
  ...
  { id: "carbonara", name: "明太カルボナーラ", genre: "season" },
];
